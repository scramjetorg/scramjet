...
module.exports = {
     ...
     * @param  {class} [ClassType=this.constructor] Optional DataStream subclass to be constructed
     *
     ...
     * @param {class} [ClassType=this.constructor] options to use to create the separated streams
