...
module.exports = {
    ...
    */
    ...
    /**
     * [Beta] Called when the stream ends without passing any items
     *
     * @todo test
    ...
    empty(callback) {
        ...
        return this.peek(1, () => empty = false);
    },

    /**
     * [Beta] Allows previewing some of the streams data without removing them from the stream.
     *
