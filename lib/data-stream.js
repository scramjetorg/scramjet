const { PromiseTransformStream, StringStream, DataStream, MultiStream, WindowStream, errors: {StreamError} } = require('./');
...
module.exports = {
    ...
    rewind(count = -1) {
        ...
        if (this.buffer) {
            ...
            throw new StreamError("Stream not buffered, cannot rewind.");
        }
    },
