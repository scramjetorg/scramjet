...
class DataStream extends PassThrough {
     ...
     *
     * @example see file: {@link ../samples/data-stream-constructor.js}
     */
    constructor(opts) {
        super(Object.assign({
     ...
     *
     * @example see file: {@link ../samples/data-stream-selfinstance.js}
     */
    _selfInstance() {
     ...
     *
     * @example see file: {@link ../samples/data-stream-debug.js}
     */
    debug(func) {
     ...
     * @return {DataStream}  self
     *
     * @example see file: {@link ../samples/data-stream-group.js}
     */
    group(/* func */) {
     ...
     * @return {DataStream}  self
     *
     * @example see file: {@link ../samples/data-stream-tee.js}
     */
    tee(func) {
     ...
     *
     * @example see file: {@link ../samples/data-stream-slice.js}
     */
    slice(/* start, end */) {
     ...
     *
     * @example see file: {@link ../samples/data-stream-reduce.js}
     */
    reduce(func, into) {
     ...
     *                    call of the transform function.
     *
     * @example see file: {@link ../samples/data-stream-reduceNow.js}
     */
    reduceNow(func, into) {
     ...
     *
     * @example see file: {@link ../samples/data-stream-map.js}
     */
    map(func) {
     ...
     *
     * @example see file: {@link ../samples/data-stream-filter.js}
     */
    filter(func) {
        return this.pipe(new DataStream({
            transform: (chunk, encoding, callback) => {
     ...
     *
     * @example see file: {@link ../samples/data-stream-pop.js}
     */
    pop(count, func) {
        const ret = [];
     ...
     * @return {MultiStream}
     *
     * @example see file: {@link ../samples/data-stream-separate.js}
     */
    separate(...funcs) {
