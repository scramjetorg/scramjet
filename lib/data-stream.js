...
module.exports = {
     ...
     * @async
     * @memberof DataStream#
     * @param {ConsumeCallback} func the consument
     * @meta.noreadme
     */
    async consume(func) {
        return this.tap()
     ...
     * @param  {*|EventEmitter} into Any object passed initially to the transform
     * function
     ...
     * @param  {class} [TypeClass=this.constructor] Optional DataStream subclass to be constructed
     *
     * @test test/methods/data-stream-remap.js
     */
    remap(func, TypeClass = this.constructor) {

        const ref = new (TypeClass || this.constructor)({referrer: this});
     ...
     */
    flatMap(func, TypeClass, ...args) {
        if (typeof TypeClass !== "function")
            TypeClass = this.constructor;

        const ref = new TypeClass({referrer: this});
    ...
    join(item, ...args) {
        ...
        if (typeof item !== "function") {
            ...
            consumer = cur => Promise.resolve(iterator.next(prev))
     ...
     * @chainable
     * @memberof DataStream#
     * @param  {Iterable} [enclosure='[]'] Any iterable object of two items (beginning and end)
     * @return {StringStream}
     * @meta.noreadme
     *
     ...
     * @memberof DataStream#
     * @param {ExecDataOptions} options options to be passed to `spawn` and defining serialization.
