...
class PromiseTransformStream extends Transform {
    ...
    pushTransform(options) {
        ...
        if (typeof options.parallelTransform === "function" && options.parallelTransform !== DefaultBeforeTransform) {
            ...
            const beforeTransform = typeof options.beforeTransform === "function" ? options.beforeTransform : DefaultBeforeTransform;
            const after = typeof options.afterTransform === "function" && options.afterTransform !== DefaultAfterTransform ? options.afterTransform : null;
            const main = options.parallelTransform;
    ...
    mkTransform() {
        ...
        this._transform = (chunk, encoding, callback) => {
            ...
            ref
                .then((arg) => (arg !== filter) && this.push(arg))
