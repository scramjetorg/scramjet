...
class StringStream extends scramjet.DataStream {
     ...
     *
     * @example see file: {@link ../samples/string-stream-constructor.js}
     */
     ...
     *
     * @example see file: {@link ../samples/string-stream-split.js}
     */
    split(splitter) {
     ...
     *
     * @example see file: {@link ../samples/string-stream-match.js}
     */
    match(matcher) {
     ...
     *
     * @example see file: {@link ../samples/string-stream-parse.js}
     */
    parse(...args) {
