...
class MultiStream extends EventEmitter {
     ...
     *
     * @example see file: {@link ../samples/multi-stream-constructor.js}
     */
     ...
     *
     * @example see file: {@link ../samples/multi-stream-map.js}
     */
    map(func) {
        return Promise.all(
            this[STREAMS].map(
     ...
     *
     * @example see file: {@link ../samples/multi-stream-filter.js}
     */
    filter(func) {
        return Promise.all(
            this[STREAMS].map(
     ...
     *
     * @example see file: {@link ../samples/multi-stream-dedupe.js}
     */
    dedupe(cmp, Clazz) {
        cmp = cmp || (() => {
     ...
     *
     * @example see file: {@link ../samples/multi-stream-mux.js}
     */
    mux(cmp, Clazz) {
        if (Clazz) {
            this[OUT] = new Clazz();
     ...
     *
     * @example see file: {@link ../samples/multi-stream-add.js}
     */
    add(stream) {
        if (stream) {
     ...
     * @param {stream.Readable} stream [description]
     *
     * @example see file: {@link ../samples/multi-stream-remove.js}
     */
    remove(stream) {
