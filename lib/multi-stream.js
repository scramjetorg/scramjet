...
class MultiStream extends EventEmitter {
    ...
    /**
     * Distributes streams to newly created threads
     *
     * @param {Number} threads the number of threads to create
     */
    cluster() {
        return this;
    }
    ...
    /**
     * Distributes streams to a list of servers
     *
     * @param {Array.<ServerDefinition>} receivers list of servers to send streams and transforms to
     */
    loadBalance() {
        return this;
    }
     ...
     *
     * @param  {MapCallback} func Mapper ran in Promise::then (so you can
