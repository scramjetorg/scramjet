...
declare module 'scramjet' {
    ...
    class WindowStream {
         ...
         */
        sum(valueOf?: ValueOfCallback): Promise<Number>;

        /**
         * Calculates the moving average of all items in the stream.
         * @param valueOf value of method for array items
         */
        avg(valueOf?: ValueOfCallback): Promise<Number>;
...
declare class DataStream {
     ...
     */
    consume(func: ConsumeCallback): Promise;
...
declare class StringStream {
     ...
     */
    shift(bytes: Number, func: ShiftStringCallback): StringStream;
     ...
     */
    append(param: Function | String): StringStream;
     ...
     * @param func Function that receives a string of shifted chars.
     */
    pop(bytes: Number, func: ShiftStringCallback): StringStream;
