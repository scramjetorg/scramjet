...
* [StringStream](#StringStream)  <code>DataStream</code>
    ...
    * [stringStream.exec(cmd, options, args)](#StringStream+exec)
...
### stringStream.exec(cmd, options, args)
...
| args | <code>String</code> | addtional arguments (will overwrite to SpawnOptions args even if not given) |
